  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="border-l-4 border-l-[#8b4049]">
          <CardHeader>
            <CardTitle className="flex items-center text-sm">
              <AlertTriangle className="h-4 w-4 mr-2 text-[#8b4049]" />
              Critical
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-[#8b4049]">
              {/* TODO: Critical count */}
              X
            </p>
          </CardContent>
        ...
        <Card className="border-l-4 border-l-[#d9ed92]">
          <CardHeader>
            <CardTitle className="text-sm">High</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-[#d9ed92]">
              {/* TODO: High count */}
              X
            </p>
          </CardContent>
        ...
        <Card className="border-l-4 border-l-[#1a759f]">
          ...
          <CardContent>
            <p className="text-3xl font-bold text-[#1a759f]">
              {/* TODO: Medium count */}
              X
            </p>
          </CardContent>
        ...
        <Card className="border-l-4 border-l-[#76c893]">
          <CardHeader>
            <CardTitle className="flex items-center text-sm">
              <Shield className="h-4 w-4 mr-2 text-[#76c893]" />
              Resolved
            </CardTitle>
          </CardHeader>
          <CardContent>
